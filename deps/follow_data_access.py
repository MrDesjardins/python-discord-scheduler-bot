...
def save_following_user(
    user_id_who_want_follow_id: int, user_to_follow_id: int, time: datetime
) -> None:
    """
    ...
    """,
        {"user_id_who_want_follow_id": user_id_who_want_follow_id, "user_to_follow_id": user_to_follow_id, "time": time},
    )
    database_manager.get_conn().commit()
    
def remove_following_user(
    user_id_who_want_unfollow_id: int, user_to_unfollow_id: int
) -> None:
    """
...
def fetch_all_followed_users_by_user_id(
    user_id_who_follow_id: int
) -> list[int]:
    """
...
def fetch_all_followers_of_user_id(
    user_id_being_followed: int
) -> list[int]:
    """
