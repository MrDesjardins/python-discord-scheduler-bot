...
- The creator uses `/privatechannelinvite @user` to grant a member access and send them a DM with a join link.
...
# Community-backed match markets are the default; use parimutuel for member-only pools.
TRIBEMARKETS_SETTLEMENT_RULE=sponsored_parimutuel
TRIBEMARKETS_SPONSOR_LIQUIDITY=100
