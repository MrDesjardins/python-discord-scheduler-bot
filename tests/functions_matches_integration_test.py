...
class MatchStatsExtration(unittest.TestCase):
    ...
    def test_get_r6tracker_user_recent_matches(self):
        ...
        self.assertEqual(match.user_ubisoft_name, "noSleep_rb6")
        ...
        self.assertEqual(match.has_ace, False)
        match = lst[1]
        self.assertEqual(match.r6_tracker_user_uuid, "877a703b-0d29-4779-8fbf-ccd165c2b7f6")
        self.assertEqual(match.user_ubisoft_name, "noSleep_rb6")
    ...
    def test_individual_gaming_session_stats(self):
        ...
        self.assertEqual(result.user_ubisoft_name, "noSleep_rb6")
        self.assertEqual(result.kill_death, ["0/4/0", "6/2/1", "7/4/1", "6/4/3", "4/4/1", "6/1/0", "2/2/1", "5/6/1"])
